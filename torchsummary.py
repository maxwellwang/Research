...
def summary(model, input_size, batch_size=-1, device=torch.device('cpu'), dtypes=None):
    total_layers, total_params, layers_summary = summary_string(model, input_size, batch_size, device, dtypes)
    return total_layers, total_params.item(), layers_summary
...
def summary_string(model, input_size, batch_size=-1, device=torch.device('cpu'), dtypes=None):
    ...
    summary_str += "----------------------------------------------------------------" + "\n"
    return total_layers, total_params, summary
