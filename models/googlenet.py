...
def googlenet(dataset, pretrained: bool = False, progress: bool = True, **kwargs: Any) -> "GoogLeNet":
    ...
    return GoogLeNet(dataset, **kwargs)
...
class GoogLeNet(nn.Module):
    ...
    def __init__(
        ...
        self.fc = nn.Linear(64, num_classes)  # change to input of first commented out block
