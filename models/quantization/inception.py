...
def inception_v3(pretrained=False, progress=True, quantize=False, **kwargs):
    ...
    .. note::
        **Important**: In contrast to the other models_MNIST the inception_v3 expects tensors with a size of
        N x 3 x 299 x 299, so ensure your images are sized accordingly.

    Note that quantize = True returns a quantized model with 8 bit
    weights. Quantized models_MNIST only support inference and run on CPUs.
