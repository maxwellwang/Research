...
class MNASNet(torch.nn.Module):
    ...
    def __init__(
        ...
        layers = [
            ...
            nn.Conv2d(depths[1], 1280, 1, padding=0, stride=1, bias=False),
...
def mnasnet0_5(dataset, pretrained: bool = False, progress: bool = True, **kwargs: Any) -> MNASNet:
    ...
    """
    model = MNASNet(dataset, 0.5, **kwargs)
    if pretrained:
        _load_pretrained("mnasnet0_5", model, progress)
    return model


def mnasnet0_75(dataset, pretrained: bool = False, progress: bool = True, **kwargs: Any) -> MNASNet:
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    model = MNASNet(dataset, 0.75, **kwargs)
    if pretrained:
        _load_pretrained("mnasnet0_75", model, progress)
    return model


def mnasnet1_0(dataset, pretrained: bool = False, progress: bool = True, **kwargs: Any) -> MNASNet:
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    model = MNASNet(dataset, 1.0, **kwargs)
    if pretrained:
        _load_pretrained("mnasnet1_0", model, progress)
    return model


def mnasnet1_3(dataset, pretrained: bool = False, progress: bool = True, **kwargs: Any) -> MNASNet:
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    model = MNASNet(dataset, 1.3, **kwargs)
    if pretrained:
